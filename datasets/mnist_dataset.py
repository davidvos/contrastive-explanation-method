...
class MNISTDataset(Dataset):
    ...
    def __init__(self, download=False, batch_size=4, shuffle=True):
        self.train_data = datasets.MNIST(root='./data/mnist', train=True, download=download, transform=None)
        self.test_data = datasets.MNIST(root='./data/mnist', train=False, download=download, transform=None)
