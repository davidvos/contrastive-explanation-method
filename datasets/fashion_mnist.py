...
class FashionMNIST(Dataset):
    ...
    def __init__(self, download=False, batch_size=4, shuffle=True):
        ...
        self.train_data = datasets.FashionMNIST(
            root='./datasets/data/fashion_mnist', train=True, download=download, transform=transform)
        self.test_data = datasets.FashionMNIST(
            root='./datasets/data/fashion_mnist', train=False, download=download, transform=transform)
