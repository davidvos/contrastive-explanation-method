...
class FashionMNIST(Dataset):
    ...
    def __init__(self, download=False, batch_size=4, shuffle=True):
        ...
        self.train_data = datasets.FashionMNIST(
            root='./cem/datasets/data/fashion_mnist', train=True, download=download, transform=transform)
        self.test_data = datasets.FashionMNIST(
            root='./cem/datasets/data/fashion_mnist', train=False, download=download, transform=transform)
        # Create a shuffled dataloader for the test and the train set, with a specified batch size.
        ...
        # A non-shuffled dataloader with a batch size of 1 for the train and test set
